    ...
    return (
        <section className="bg-white mt-20 mb-20">
            <div className="max-w-2xl px-6 text-center mx-auto">
                ...
                <p className="text-gray-600 mt-4">I'm a 4th year Computer Science student at Dalhousie University seeking employment opportunities for the Summer of 2022.</p>
